			...
			<div>
				<Form
					...
					<InputGroup>
						...
						<Input
							...
							placeholder={ (this.state.type === 'Title') ? 'Search Restuarants' : 'Search Reviews' }
							name="search"
...

				{
					...
					<Modal
						...
						<ModalBody>
							<p>
								<span className="font-weight-bold">Year of visit: </span>
								{ this.state.movie.year }
							</p>
							<p>
								<span className="font-weight-bold">Cuisine: </span>
